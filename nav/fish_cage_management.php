 ...
 var logoBase64 = "<?= $base64Logo ?>";
        ...
        buttons: [
            {
                ...
                title: 'Fish Cage Management Report', // Report title
    ...
    // 4. Add "Prepared By" at the bottom
        ...
        var signatureRows = `
            <row r="${footerRow}">
                ...
                <c r="F${footerRow}" t="inlineStr"><is><t>Approved By: ____________________</t></is></c>
            </row>
        `;
                    ...
                    root.prepend(`
                        <div style="display: flex; justify-content: space-between; align-items: flex-end; border-bottom: 2px solid #333; padding-bottom: 10px; margin-bottom: 20px;">
                            ...
                            <div style="text-align: right;">
                                <h2 style="margin: 0; font-size: 18px; color: #2d3748; text-transform: uppercase;">Fish Cage Management Report</h2>
    ...
    return {
        columns: [
            ...
            {
                stack: [
                    { text: 'Fish Cage Management Report', style: 'reportTitle', alignment: 'right' },
...
doc.pageMargins = [35, 70, 40, 50]; // [left, top, right, bottom]
        ...
        columnDefs: [
            ...
            { width: "150px", targets: 2 }, // Management Date
            { width: "130px", targets: 3 }, // Result
            { width: "140px", targets: 4 }, // Optimum Level
            { width: "180px", targets: 5 }, // Remarks

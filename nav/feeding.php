...
var logoBase64 = "<?= $base64Logo ?>";
        ...
        buttons: [
            {
                ...
                title: 'Feeding Report', // Report title
                    ...
                    root.prepend(`
                        <div style="display: flex; justify-content: space-between; align-items: flex-end; border-bottom: 2px solid #333; padding-bottom: 10px; margin-bottom: 20px;">
                            ...
                            <div style="text-align: right;">
                                <h2 style="margin: 0; font-size: 18px; color: #2d3748; text-transform: uppercase;">Feeding Report</h2>
    ...
    return {
        columns: [
            ...
            {
                stack: [
                    { text: 'Feeding Report', style: 'reportTitle', alignment: 'right' },
...
doc.pageMargins = [35, 70, 40, 50]; // [left, top, right, bottom]
        ...
        columnDefs: [
            ...
            { width: "140px", targets: 1 }, // Cage Name
            { width: "150px", targets: 2 }, // Date of Feeding
            { width: "160px", targets: 3 }, // Types of Feed
            { width: "130px", targets: 4 }, // Amount of Feed
            { width: "120px", targets: 5 }, // Fed Time

...
var logoBase64 = "<?= $base64Logo ?>";
        ...
        buttons: [
            {
                ...
                title: 'Net Repairing Report', // Report title
                    ...
                    root.prepend(`
                        <div style="display: flex; justify-content: space-between; align-items: flex-end; border-bottom: 2px solid #333; padding-bottom: 10px; margin-bottom: 20px;">
                            ...
                            <div style="text-align: right;">
                                <h2 style="margin: 0; font-size: 18px; color: #2d3748; text-transform: uppercase;">Net Repairing Report</h2>
    ...
    return {
        columns: [
            ...
            {
                stack: [
                    { text: 'Net Repairing Report', style: 'reportTitle', alignment: 'right' },

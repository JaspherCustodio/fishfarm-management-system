...
include "../model/net_checking.php";
...
$schedules = $conn->query("
    ...
    LEFT JOIN net_checking nc ON nc.schedule_id = s.id
...
$checkings = get_all_net_checking($conn);
...
<body class="dashboard-page">
		...
		<section class="section-1">
            ...
            <div class="content-card">
                <div class="card-header">
                    ...
                    <?php if ($isAdmin): ?>
                    <button class="btn-add" onclick="openAddNetCheckingModal()">
    ...
    data-assigned_name="<?= htmlspecialchars($row['assigned_name']) ?>"
                            ...
                            <?php if ($isAdmin): ?>
                            <a href="../model/delete_net_checking.php?id=<?= $row['id'] ?>" class="delete-btn">
    ...
    <!-- Add User Modal -->
    <div id="addNetCheckingModal" class="modal-overlay">
        <div class="modal">
            <div class="modal-header">
                <h3>Add Record</h3>
                <button class="close-btn" onclick="closeAddNetCheckingModal()">&times;</button>
            </div>

            <form action="../model/create_net_checking.php" method="POST">
            ...
            <select name="assigned_to" required>
                ...
                <div class="modal-actions">
                    ...
                    <button type="button" class="btn-cancel" onclick="closeAddNetCheckingModal()">Cancel</button>
                </div>
            </form>
        </div>
    </div>

    <div id="editNetCheckingModal" class="modal-overlay">
        <div class="modal">
            <div class="modal-header">
                <h3>Edit Record</h3>
                <button class="close-btn" onclick="closeEditNetCheckingModal()">&times;</button>
            </div>

            <form action="../model/update_net_checking.php" method="POST">
            ...
            <?php endif; ?>
                ...
                <div class="modal-actions">
                    ...
                    <button type="button" class="btn-cancel" onclick="closeEditNetCheckingModal()">Cancel</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js"></script>
    <script>
        /* ✅ ADD THESE */
        function openAddNetCheckingModal() {
            document.getElementById("addNetCheckingModal").style.display = "flex";
        }

        function closeAddNetCheckingModal() {
            document.getElementById("addNetCheckingModal").style.display = "none";
        }
        ...
        function openEditNetCheckingModal(data) {
        ...
        assignedSelect.value = data.assigned_to || '';
            ...
            document.getElementById('editNetCheckingModal').style.display = 'flex';
        }

        function closeEditNetCheckingModal() {
            document.getElementById('editNetCheckingModal').style.display = 'none';
        }

        document.querySelectorAll('.edit-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                openEditNetCheckingModal(btn.dataset);
            });
        });
        ...
        window.addEventListener('load', () => {
            ...
            if (params.get('add') === 'true' && <?= $isAdmin ? 'true' : 'false' ?>) {
                setTimeout(openAddNetCheckingModal, 150);
            }
        });
...
var logoBase64 = "<?= $base64Logo ?>";
        ...
        buttons: [
            {
                ...
                title: 'Net Checking Report', // Report title
                    ...
                    root.prepend(`
                        <div style="display: flex; justify-content: space-between; align-items: flex-end; border-bottom: 2px solid #333; padding-bottom: 10px; margin-bottom: 20px;">
                            ...
                            <div style="text-align: right;">
                                <h2 style="margin: 0; font-size: 18px; color: #2d3748; text-transform: uppercase;">Net Checking Report</h2>
    ...
    return {
        columns: [
            ...
            {
                stack: [
                    { text: 'Net Checking Report', style: 'reportTitle', alignment: 'right' },

...
window.addEventListener('load', () => {
        ...
        buttons: [
            {
                ...
                title: 'Fish Cage Report', // Report title
    ...
    // 4. Add "Prepared By" at the bottom
        ...
        var signatureRows = `
            <row r="${footerRow}">
                ...
                <c r="B${footerRow}" t="inlineStr"><is><t>Approved By: ____________________</t></is></c>
            </row>
        `;
                    ...
                    root.prepend(`
                        <div style="display: flex; justify-content: space-between; align-items: flex-end; border-bottom: 2px solid #333; padding-bottom: 10px; margin-bottom: 20px;">
                            ...
                            <div style="text-align: right;">
                                <h2 style="margin: 0; font-size: 18px; color: #2d3748; text-transform: uppercase;">Fish Cage Report</h2>
    ...
    return {
        columns: [
            ...
            {
                stack: [
                    { text: 'Fish Cage Report', style: 'reportTitle', alignment: 'right' },

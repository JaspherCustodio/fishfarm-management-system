...
if (!$schedule_id || !$assigned_to) {
    ...
    header("Location: ../nav/net_repairing.php?add=true");
    exit();
}

// 2️⃣ Insert into net_cleaning table
$stmt = $conn->prepare("
    INSERT INTO net_repairing
...
$title   = "New Net Repairing Task Assigned";
$message = "You have been assigned a Net Repairing task for cage \"$cageName\" scheduled on $datetime.";
...
// 5️⃣ Success popup
$_SESSION['popup_success'] = "Net Repairing record added successfully and notification sent.";
header("Location: ../nav/net_repairing.php");
exit();

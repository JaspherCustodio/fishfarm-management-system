...
if (!$schedule_id || !$assigned_to) {
    ...
    header("Location: ../nav/net_checking.php?add=true");
    exit();
}

// 3️⃣ Insert into net_checking table
$stmt = $conn->prepare("
    INSERT INTO net_checking
...
// 4️⃣ Get schedule info for notification
...
$title   = "New Net Checking Task Assigned";
$message = "You have been assigned a Net Checking task for cage \"$cageName\" scheduled on $datetime.";
...
// 6️⃣ Success popup
$_SESSION['popup_success'] = "Net Checking record added successfully and notification sent.";
